...
// Production HSK vocabulary is generated by scripts/import-hsk-xlsx.py (#81).
// The importer emits deterministic immutable batch files (≤50 rows each) plus
// a manifest under data/vocabulary/hsk-3.0-v1/. Every batch is validated
// against the #74 HSK content contract before it is written.
const DEFAULT_HSK_PATH = 'data/vocabulary/hsk-3.0-v1/hsk-vocabulary-batch-01.json';
