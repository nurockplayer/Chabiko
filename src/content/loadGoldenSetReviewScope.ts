...
export function renderGoldenSetReviewPacket(packet: GoldenSetReviewPacket): string {
  ...
  return [
    ...
    '**Overall review outcome:** pending-human-review (the canonical human artifact must record accepted, rejected, or needs-changes; this packet has no decision)',
    '**Decision storage:** No decisions recorded; if a future writer is added, accepted maps to accepted and needs-changes maps to needs_changes; rejected remains non-promotable and is never written as an accepted decision.',
    '',
    '## Approval Scope',
    '',
