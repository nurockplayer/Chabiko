...
- [ ] **Phase 3: Learning Experience and Practice** - Build the learner-facing pages, filters, phrase navigation, and no-login practice.
...
**Depends on**: Phase 1
**Requirements**: LEARN-01, LEARN-02, ONYOMI-01, ONYOMI-02, TRAVEL-01, TRAVEL-02
**UI hint**: no
**Success Criteria** (what must be TRUE):
  ...
  4. Every content item has review/source metadata.
**Plans**: 3 plans
...
**Depends on**: Phase 2
**Requirements**: LEARN-03, ONYOMI-03, TRAVEL-03, PRACT-01, PRACT-02, PRACT-03
**UI hint**: yes
**Success Criteria** (what must be TRUE):
  ...
  4. Learner can complete at least three no-login practice modes with immediate feedback and retry.
  5. Useful practice state persists locally where appropriate.
**Plans**: 3 plans
