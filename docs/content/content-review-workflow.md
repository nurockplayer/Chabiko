...
- **Source of truth reference**: The current GitHub issue and any active canonical contract it explicitly adopts govern this content. Planning, historical, or reference material governs only when that issue explicitly adopts or reactivates it; otherwise record it as evidence or context.
