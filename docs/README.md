...
- `design/v2-consumer-reference-authority.md` — canonical V2 consumer UX direction and the boundary that keeps A1 / three-track / Home Dashboard decisions V1-only.
